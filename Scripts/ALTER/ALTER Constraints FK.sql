...
alter table PRODUCCION_LOTE add (PL_FK_HIST_FABRICA	NUMBER(7)	NOT NULL,
				 PL_FK_HIST_LINEAPROD	NUMBER(7)	NOT NULL,
				 PL_FK_HIST_PRODUCTO	NUMBER(7)	NOT NULL,
				 PL_FK_HIST_FECHAI	DATE	NOT NULL);

alter table PRODUCCION_LOTE
   add constraint FK_PROD_LOTE_FK_HISTORICO foreign key(PL_FK_HIST_FABRICA, PL_FK_HIST_LINEAPROD, PL_FK_HIST_PRODUCTO, PL_FK_HIST_FECHAI)
<<<<<<< HEAD
      references HISTORICO_PRODUCTO (HP_FK_FABRICA, HP_FK_LINEAPROD, HP_FK_PRODUCTO, HP_FECHAI);

--PORQUE EL TIPO DE DATO DEL HISTORICO ES DATE 
ALTER TABLE PRODUCCION_LOTE MODIFY PL_FK_HIST_FECHAI DATE; 
=======
      references HISTORICO_PRODUCTO (HP_FK_FABRICA, HP_FK_LINEAPROD, HP_FK_PRODUCTO, HP_FECHAI);
>>>>>>> 01c356321c23258f2d9d7cf2e445ea74007028da
