...
begin
 a_prod(1):=70756; a_cant(1):=1; a_prod(2):=851342; a_cant(2):=2;NUEVA_VENTA.REALIZAR_VENTA(1,11,a_prod,a_cant);
 a_prod(1):=75873; a_cant(1):=3; a_prod(2):=70600; a_cant(2):=1;NUEVA_VENTA.REALIZAR_VENTA(1,18,a_prod,a_cant);
 a_prod(1):=75908; a_cant(1):=1; a_prod(2):=75871; a_cant(2):=3;NUEVA_VENTA.REALIZAR_VENTA(1,14,a_prod,a_cant);
 a_prod(1):=75871; a_cant(1):=2; a_prod(2):=75909; a_cant(2):=4;NUEVA_VENTA.REALIZAR_VENTA(1,15,a_prod,a_cant);
 a_prod(1):=75910; a_cant(1):=2; a_prod(2):=75873; a_cant(2):=1;NUEVA_VENTA.REALIZAR_VENTA(1,9,a_prod,a_cant);
 a_prod(1):=75899; a_cant(1):=1; a_prod(2):=75873; a_cant(2):=5;NUEVA_VENTA.REALIZAR_VENTA(1,6,a_prod,a_cant);
 a_prod(1):=75909; a_cant(1):=5; a_prod(2):=75871; a_cant(2):=2;NUEVA_VENTA.REALIZAR_VENTA(2,13,a_prod,a_cant);
 a_prod(1):=851345; a_cant(1):=5; a_prod(2):=75899; a_cant(2):=5;NUEVA_VENTA.REALIZAR_VENTA(2,20,a_prod,a_cant);
 a_prod(1):=75910; a_cant(1):=2; a_prod(2):=75872; a_cant(2):=3;NUEVA_VENTA.REALIZAR_VENTA(2,5,a_prod,a_cant);
 a_prod(1):=70756; a_cant(1):=4; a_prod(2):=75871; a_cant(2):=1;NUEVA_VENTA.REALIZAR_VENTA(2,2,a_prod,a_cant);
 a_prod(1):=70747; a_cant(1):=5; a_prod(2):=851352; a_cant(2):=3;NUEVA_VENTA.REALIZAR_VENTA(2,15,a_prod,a_cant);
 a_prod(1):=75910; a_cant(1):=3; a_prod(2):=851352; a_cant(2):=5;NUEVA_VENTA.REALIZAR_VENTA(2,8,a_prod,a_cant);
 a_prod(1):=75870; a_cant(1):=5; a_prod(2):=75908; a_cant(2):=1;NUEVA_VENTA.REALIZAR_VENTA(3,4,a_prod,a_cant);
 a_prod(1):=70751; a_cant(1):=3; a_prod(2):=5005117; a_cant(2):=1;NUEVA_VENTA.REALIZAR_VENTA(3,6,a_prod,a_cant);
 a_prod(1):=75913; a_cant(1):=5; a_prod(2):=75899; a_cant(2):=2;NUEVA_VENTA.REALIZAR_VENTA(3,12,a_prod,a_cant);
 a_prod(1):=75871; a_cant(1):=3; a_prod(2):=75876; a_cant(2):=1;NUEVA_VENTA.REALIZAR_VENTA(3,4,a_prod,a_cant);
 a_prod(1):=75908; a_cant(1):=5; a_prod(2):=75909; a_cant(2):=5;NUEVA_VENTA.REALIZAR_VENTA(3,15,a_prod,a_cant);
 a_prod(1):=70747; a_cant(1):=4; a_prod(2):=851345; a_cant(2):=4;NUEVA_VENTA.REALIZAR_VENTA(3,17,a_prod,a_cant);
 a_prod(1):=75873; a_cant(1):=3; a_prod(2):=851345; a_cant(2):=5;NUEVA_VENTA.REALIZAR_VENTA(4,12,a_prod,a_cant);
 a_prod(1):=851342; a_cant(1):=1; a_prod(2):=75873; a_cant(2):=2;NUEVA_VENTA.REALIZAR_VENTA(4,15,a_prod,a_cant);
 a_prod(1):=5005117; a_cant(1):=3; a_prod(2):=75909; a_cant(2):=5;NUEVA_VENTA.REALIZAR_VENTA(4,9,a_prod,a_cant);
 a_prod(1):=75873; a_cant(1):=4; a_prod(2):=70756; a_cant(2):=5;NUEVA_VENTA.REALIZAR_VENTA(4,17,a_prod,a_cant);
 a_prod(1):=851352; a_cant(1):=3; a_prod(2):=75872; a_cant(2):=3;NUEVA_VENTA.REALIZAR_VENTA(4,11,a_prod,a_cant);
 a_prod(1):=75913; a_cant(1):=5; a_prod(2):=70747; a_cant(2):=5;NUEVA_VENTA.REALIZAR_VENTA(4,10,a_prod,a_cant);
 a_prod(1):=70756; a_cant(1):=5; a_prod(2):=70747; a_cant(2):=2;NUEVA_VENTA.REALIZAR_VENTA(5,14,a_prod,a_cant);
 a_prod(1):=75872; a_cant(1):=4; a_prod(2):=851345; a_cant(2):=4;NUEVA_VENTA.REALIZAR_VENTA(5,19,a_prod,a_cant);
 a_prod(1):=75871; a_cant(1):=2; a_prod(2):=75899; a_cant(2):=4;NUEVA_VENTA.REALIZAR_VENTA(5,1,a_prod,a_cant);
 a_prod(1):=75899; a_cant(1):=2; a_prod(2):=75910; a_cant(2):=3;NUEVA_VENTA.REALIZAR_VENTA(5,13,a_prod,a_cant);
 a_prod(1):=70751; a_cant(1):=3; a_prod(2):=70751; a_cant(2):=1;NUEVA_VENTA.REALIZAR_VENTA(5,6,a_prod,a_cant);
 a_prod(1):=75909; a_cant(1):=2; a_prod(2):=70751; a_cant(2):=5;NUEVA_VENTA.REALIZAR_VENTA(5,11,a_prod,a_cant);
 a_prod(1):=70747; a_cant(1):=2; a_prod(2):=70747; a_cant(2):=4;NUEVA_VENTA.REALIZAR_VENTA(6,5,a_prod,a_cant);
 a_prod(1):=851352; a_cant(1):=4; a_prod(2):=75870; a_cant(2):=3;NUEVA_VENTA.REALIZAR_VENTA(6,10,a_prod,a_cant);
 a_prod(1):=75910; a_cant(1):=4; a_prod(2):=75870; a_cant(2):=3;NUEVA_VENTA.REALIZAR_VENTA(6,10,a_prod,a_cant);
 a_prod(1):=70756; a_cant(1):=5; a_prod(2):=851352; a_cant(2):=3;NUEVA_VENTA.REALIZAR_VENTA(6,6,a_prod,a_cant);
 a_prod(1):=75872; a_cant(1):=5; a_prod(2):=70751; a_cant(2):=1;NUEVA_VENTA.REALIZAR_VENTA(6,8,a_prod,a_cant);
 a_prod(1):=70600; a_cant(1):=1; a_prod(2):=75870; a_cant(2):=3;NUEVA_VENTA.REALIZAR_VENTA(6,16,a_prod,a_cant);
 a_prod(1):=75871; a_cant(1):=1; a_prod(2):=70756; a_cant(2):=4;NUEVA_VENTA.REALIZAR_VENTA(7,9,a_prod,a_cant);
 a_prod(1):=5005117; a_cant(1):=1; a_prod(2):=75910; a_cant(2):=4;NUEVA_VENTA.REALIZAR_VENTA(7,7,a_prod,a_cant);
 a_prod(1):=851342; a_cant(1):=3; a_prod(2):=75872; a_cant(2):=3;NUEVA_VENTA.REALIZAR_VENTA(7,2,a_prod,a_cant);
 a_prod(1):=851352; a_cant(1):=1; a_prod(2):=75913; a_cant(2):=3;NUEVA_VENTA.REALIZAR_VENTA(7,10,a_prod,a_cant);
 a_prod(1):=75909; a_cant(1):=3; a_prod(2):=75871; a_cant(2):=2;NUEVA_VENTA.REALIZAR_VENTA(7,10,a_prod,a_cant);
 a_prod(1):=70756; a_cant(1):=3; a_prod(2):=851345; a_cant(2):=4;NUEVA_VENTA.REALIZAR_VENTA(7,17,a_prod,a_cant);
 a_prod(1):=851342; a_cant(1):=1; a_prod(2):=75876; a_cant(2):=5;NUEVA_VENTA.REALIZAR_VENTA(8,2,a_prod,a_cant);
 a_prod(1):=5005117; a_cant(1):=3; a_prod(2):=75908; a_cant(2):=4;NUEVA_VENTA.REALIZAR_VENTA(8,8,a_prod,a_cant);
 a_prod(1):=851345; a_cant(1):=3; a_prod(2):=75872; a_cant(2):=1;NUEVA_VENTA.REALIZAR_VENTA(8,2,a_prod,a_cant);
 a_prod(1):=851342; a_cant(1):=5; a_prod(2):=70600; a_cant(2):=5;NUEVA_VENTA.REALIZAR_VENTA(8,17,a_prod,a_cant);
 a_prod(1):=75899; a_cant(1):=2; a_prod(2):=851352; a_cant(2):=5;NUEVA_VENTA.REALIZAR_VENTA(8,13,a_prod,a_cant);
 a_prod(1):=851342; a_cant(1):=3; a_prod(2):=5005117; a_cant(2):=5;NUEVA_VENTA.REALIZAR_VENTA(8,15,a_prod,a_cant);
 a_prod(1):=75913; a_cant(1):=1; a_prod(2):=75873; a_cant(2):=2;NUEVA_VENTA.REALIZAR_VENTA(9,8,a_prod,a_cant);
 a_prod(1):=70756; a_cant(1):=3; a_prod(2):=75913; a_cant(2):=3;NUEVA_VENTA.REALIZAR_VENTA(9,1,a_prod,a_cant);
 a_prod(1):=851352; a_cant(1):=3; a_prod(2):=70747; a_cant(2):=3;NUEVA_VENTA.REALIZAR_VENTA(9,1,a_prod,a_cant);
 a_prod(1):=851345; a_cant(1):=1; a_prod(2):=70747; a_cant(2):=4;NUEVA_VENTA.REALIZAR_VENTA(9,17,a_prod,a_cant);
 a_prod(1):=851352; a_cant(1):=2; a_prod(2):=75873; a_cant(2):=5;NUEVA_VENTA.REALIZAR_VENTA(9,4,a_prod,a_cant);
 a_prod(1):=851352; a_cant(1):=3; a_prod(2):=75873; a_cant(2):=2;NUEVA_VENTA.REALIZAR_VENTA(9,9,a_prod,a_cant);
 a_prod(1):=70747; a_cant(1):=5; a_prod(2):=851342; a_cant(2):=1;NUEVA_VENTA.REALIZAR_VENTA(10,11,a_prod,a_cant);
 a_prod(1):=75913; a_cant(1):=5; a_prod(2):=70747; a_cant(2):=2;NUEVA_VENTA.REALIZAR_VENTA(10,15,a_prod,a_cant);
 a_prod(1):=70600; a_cant(1):=1; a_prod(2):=75873; a_cant(2):=2;NUEVA_VENTA.REALIZAR_VENTA(10,8,a_prod,a_cant);
 a_prod(1):=75909; a_cant(1):=1; a_prod(2):=75908; a_cant(2):=3;NUEVA_VENTA.REALIZAR_VENTA(10,15,a_prod,a_cant);
 a_prod(1):=70756; a_cant(1):=5; a_prod(2):=851352; a_cant(2):=1;NUEVA_VENTA.REALIZAR_VENTA(10,18,a_prod,a_cant);
 a_prod(1):=75909; a_cant(1):=1; a_prod(2):=75909; a_cant(2):=3;NUEVA_VENTA.REALIZAR_VENTA(10,1,a_prod,a_cant);
 a_prod(1):=75910; a_cant(1):=1; a_prod(2):=5005117; a_cant(2):=4;NUEVA_VENTA.REALIZAR_VENTA(11,10,a_prod,a_cant);
 a_prod(1):=75899; a_cant(1):=2; a_prod(2):=75870; a_cant(2):=3;NUEVA_VENTA.REALIZAR_VENTA(11,3,a_prod,a_cant);
 a_prod(1):=75871; a_cant(1):=1; a_prod(2):=70747; a_cant(2):=3;NUEVA_VENTA.REALIZAR_VENTA(11,14,a_prod,a_cant);
 a_prod(1):=75871; a_cant(1):=3; a_prod(2):=75872; a_cant(2):=3;NUEVA_VENTA.REALIZAR_VENTA(11,7,a_prod,a_cant);
 a_prod(1):=70756; a_cant(1):=2; a_prod(2):=70756; a_cant(2):=5;NUEVA_VENTA.REALIZAR_VENTA(11,8,a_prod,a_cant);
 a_prod(1):=75873; a_cant(1):=5; a_prod(2):=75913; a_cant(2):=2;NUEVA_VENTA.REALIZAR_VENTA(11,5,a_prod,a_cant);
 a_prod(1):=75899; a_cant(1):=2; a_prod(2):=70600; a_cant(2):=4;NUEVA_VENTA.REALIZAR_VENTA(12,2,a_prod,a_cant);
 a_prod(1):=75870; a_cant(1):=2; a_prod(2):=70751; a_cant(2):=1;NUEVA_VENTA.REALIZAR_VENTA(12,10,a_prod,a_cant);
 a_prod(1):=75876; a_cant(1):=5; a_prod(2):=70747; a_cant(2):=3;NUEVA_VENTA.REALIZAR_VENTA(12,15,a_prod,a_cant);
 a_prod(1):=75908; a_cant(1):=2; a_prod(2):=70600; a_cant(2):=3;NUEVA_VENTA.REALIZAR_VENTA(12,2,a_prod,a_cant);
 a_prod(1):=70751; a_cant(1):=5; a_prod(2):=75908; a_cant(2):=2;NUEVA_VENTA.REALIZAR_VENTA(12,12,a_prod,a_cant);
 a_prod(1):=70756; a_cant(1):=3; a_prod(2):=70747; a_cant(2):=3;NUEVA_VENTA.REALIZAR_VENTA(12,3,a_prod,a_cant);
 a_prod(1):=75913; a_cant(1):=1; a_prod(2):=70747; a_cant(2):=2;NUEVA_VENTA.REALIZAR_VENTA(13,15,a_prod,a_cant);
 a_prod(1):=75899; a_cant(1):=3; a_prod(2):=70756; a_cant(2):=5;NUEVA_VENTA.REALIZAR_VENTA(13,19,a_prod,a_cant);
 a_prod(1):=70751; a_cant(1):=4; a_prod(2):=75870; a_cant(2):=5;NUEVA_VENTA.REALIZAR_VENTA(13,13,a_prod,a_cant);
 a_prod(1):=851342; a_cant(1):=1; a_prod(2):=5005117; a_cant(2):=4;NUEVA_VENTA.REALIZAR_VENTA(13,13,a_prod,a_cant);
 a_prod(1):=75876; a_cant(1):=3; a_prod(2):=75872; a_cant(2):=1;NUEVA_VENTA.REALIZAR_VENTA(13,9,a_prod,a_cant);
 a_prod(1):=75876; a_cant(1):=5; a_prod(2):=851352; a_cant(2):=4;NUEVA_VENTA.REALIZAR_VENTA(13,5,a_prod,a_cant);
 a_prod(1):=75871; a_cant(1):=4; a_prod(2):=5005117; a_cant(2):=2;NUEVA_VENTA.REALIZAR_VENTA(14,9,a_prod,a_cant);
 a_prod(1):=5005117; a_cant(1):=5; a_prod(2):=75872; a_cant(2):=4;NUEVA_VENTA.REALIZAR_VENTA(14,10,a_prod,a_cant);
 a_prod(1):=75913; a_cant(1):=5; a_prod(2):=75909; a_cant(2):=2;NUEVA_VENTA.REALIZAR_VENTA(14,19,a_prod,a_cant);
 a_prod(1):=75876; a_cant(1):=1; a_prod(2):=70600; a_cant(2):=5;NUEVA_VENTA.REALIZAR_VENTA(14,5,a_prod,a_cant);
 a_prod(1):=75909; a_cant(1):=4; a_prod(2):=851345; a_cant(2):=3;NUEVA_VENTA.REALIZAR_VENTA(14,11,a_prod,a_cant);
 a_prod(1):=851345; a_cant(1):=1; a_prod(2):=75870; a_cant(2):=2;NUEVA_VENTA.REALIZAR_VENTA(14,10,a_prod,a_cant);
 a_prod(1):=75908; a_cant(1):=3; a_prod(2):=5005117; a_cant(2):=3;NUEVA_VENTA.REALIZAR_VENTA(15,15,a_prod,a_cant);
 a_prod(1):=75909; a_cant(1):=2; a_prod(2):=75871; a_cant(2):=1;NUEVA_VENTA.REALIZAR_VENTA(15,5,a_prod,a_cant);
 a_prod(1):=70756; a_cant(1):=4; a_prod(2):=851345; a_cant(2):=1;NUEVA_VENTA.REALIZAR_VENTA(15,15,a_prod,a_cant);
 a_prod(1):=851342; a_cant(1):=5; a_prod(2):=70600; a_cant(2):=4;NUEVA_VENTA.REALIZAR_VENTA(15,7,a_prod,a_cant);
 a_prod(1):=75870; a_cant(1):=2; a_prod(2):=5005117; a_cant(2):=1;NUEVA_VENTA.REALIZAR_VENTA(15,15,a_prod,a_cant);
 a_prod(1):=75876; a_cant(1):=2; a_prod(2):=75873; a_cant(2):=1;NUEVA_VENTA.REALIZAR_VENTA(15,14,a_prod,a_cant);
 a_prod(1):=70600; a_cant(1):=5; a_prod(2):=70751; a_cant(2):=5;NUEVA_VENTA.REALIZAR_VENTA(16,17,a_prod,a_cant);
 a_prod(1):=75908; a_cant(1):=4; a_prod(2):=75872; a_cant(2):=2;NUEVA_VENTA.REALIZAR_VENTA(16,3,a_prod,a_cant);
 a_prod(1):=70747; a_cant(1):=5; a_prod(2):=70751; a_cant(2):=1;NUEVA_VENTA.REALIZAR_VENTA(16,7,a_prod,a_cant);
 a_prod(1):=5005117; a_cant(1):=4; a_prod(2):=851352; a_cant(2):=4;NUEVA_VENTA.REALIZAR_VENTA(16,4,a_prod,a_cant);
 a_prod(1):=75909; a_cant(1):=2; a_prod(2):=851352; a_cant(2):=4;NUEVA_VENTA.REALIZAR_VENTA(16,14,a_prod,a_cant);
 a_prod(1):=75873; a_cant(1):=1; a_prod(2):=70747; a_cant(2):=4;NUEVA_VENTA.REALIZAR_VENTA(16,7,a_prod,a_cant);
 a_prod(1):=75909; a_cant(1):=1; a_prod(2):=75909; a_cant(2):=1;NUEVA_VENTA.REALIZAR_VENTA(17,11,a_prod,a_cant);
 a_prod(1):=75871; a_cant(1):=2; a_prod(2):=75873; a_cant(2):=1;NUEVA_VENTA.REALIZAR_VENTA(17,10,a_prod,a_cant);
 a_prod(1):=75899; a_cant(1):=1; a_prod(2):=75872; a_cant(2):=3;NUEVA_VENTA.REALIZAR_VENTA(17,18,a_prod,a_cant);
 a_prod(1):=75871; a_cant(1):=4; a_prod(2):=70600; a_cant(2):=3;NUEVA_VENTA.REALIZAR_VENTA(17,18,a_prod,a_cant);
 a_prod(1):=75908; a_cant(1):=4; a_prod(2):=851345; a_cant(2):=5;NUEVA_VENTA.REALIZAR_VENTA(17,4,a_prod,a_cant);
 a_prod(1):=75899; a_cant(1):=3; a_prod(2):=851342; a_cant(2):=3;NUEVA_VENTA.REALIZAR_VENTA(17,7,a_prod,a_cant);
end;
/
