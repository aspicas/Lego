...
(SELECT PR_CODIGO FROM PRODUCTO WHERE PR_NOMBRE ='Minifigura despertador de Jay'),12);
INSERT INTO DISP_PROD VALUES ((SELECT PA_ID FROM PAIS WHERE PA_NOMBRE = 'UNITED STATES'),
(SELECT PR_CODIGO FROM PRODUCTO WHERE PR_NOMBRE ='Minifigura despertador de Jay'),10);
...
(SELECT PR_CODIGO FROM PRODUCTO WHERE PR_NOMBRE ='Minifigura despertador de Jay'),9);
INSERT INTO DISP_PROD VALUES ((SELECT PA_ID FROM PAIS WHERE PA_NOMBRE = 'AUSTRIA'),
(SELECT PR_CODIGO FROM PRODUCTO WHERE PR_NOMBRE ='Tapete de juego'),12);
INSERT INTO DISP_PROD VALUES ((SELECT PA_ID FROM PAIS WHERE PA_NOMBRE = 'GERMANY'),
(SELECT PR_CODIGO FROM PRODUCTO WHERE PR_NOMBRE ='Tapete de juego'),11);
INSERT INTO DISP_PROD VALUES ((SELECT PA_ID FROM PAIS WHERE PA_NOMBRE = 'BELGIUM'),
(SELECT PR_CODIGO FROM PRODUCTO WHERE PR_NOMBRE ='Tapete de juego'),10);
...
INSERT INTO DISP_PROD VALUES ((SELECT PA_ID FROM PAIS WHERE PA_NOMBRE = 'AUSTRIA'),
(SELECT PR_CODIGO FROM PRODUCTO WHERE PR_NOMBRE ='Destructor de Roca'),10);
INSERT INTO DISP_PROD VALUES ((SELECT PA_ID FROM PAIS WHERE PA_NOMBRE = 'CANADA'),
(SELECT PR_CODIGO FROM PRODUCTO WHERE PR_NOMBRE ='Tapete de juego'),10);
INSERT INTO DISP_PROD VALUES ((SELECT PA_ID FROM PAIS WHERE PA_NOMBRE = 'AUSTRIA'),(SELECT PR_CODIGO FROM PRODUCTO WHERE PR_NOMBRE ='Entrenamiento en el Dojo'),10);
INSERT INTO DISP_PROD VALUES ((SELECT PA_ID FROM PAIS WHERE PA_NOMBRE = 'CANADA'),
(SELECT PR_CODIGO FROM PRODUCTO WHERE PR_NOMBRE ='Destructor de Roca'),10);
INSERT INTO DISP_PROD VALUES ((SELECT PA_ID FROM PAIS WHERE PA_NOMBRE = 'FRANCE'),
(SELECT PR_CODIGO FROM PRODUCTO WHERE PR_NOMBRE ='Destructor de Roca'),10);
...
(SELECT PR_CODIGO FROM PRODUCTO WHERE PR_NOMBRE ='Destructor de Roca'),10);
INSERT INTO DISP_PROD VALUES ((SELECT PA_ID FROM PAIS WHERE PA_NOMBRE = 'GERMANY'),
(SELECT PR_CODIGO FROM PRODUCTO WHERE PR_NOMBRE ='Llavero de Zane: ninja de titanio'),10);
...
(SELECT PR_CODIGO FROM PRODUCTO WHERE PR_NOMBRE ='Llavero de Zane: ninja de titanio'),10);
INSERT INTO DISP_PROD VALUES ((SELECT PA_ID FROM PAIS WHERE PA_NOMBRE = 'ENGLAND'),
(SELECT PR_CODIGO FROM PRODUCTO WHERE PR_NOMBRE ='Persecución en la moto ninja'),10);
INSERT INTO DISP_PROD VALUES ((SELECT PA_ID FROM PAIS WHERE PA_NOMBRE = 'CANADA'),
(SELECT PR_CODIGO FROM PRODUCTO WHERE PR_NOMBRE ='Persecución en la moto ninja'),10);
INSERT INTO DISP_PROD VALUES ((SELECT PA_ID FROM PAIS WHERE PA_NOMBRE = 'UNITED STATES'),
(SELECT PR_CODIGO FROM PRODUCTO WHERE PR_NOMBRE ='Persecución en la moto ninja'),10);
...
(SELECT PR_CODIGO FROM PRODUCTO WHERE PR_NOMBRE ='Persecución en la moto ninja'),10);
INSERT INTO DISP_PROD VALUES ((SELECT PA_ID FROM PAIS WHERE PA_NOMBRE = 'SWEDEN'),
(SELECT PR_CODIGO FROM PRODUCTO WHERE PR_NOMBRE ='Set de construcción de ejércitos'),10);
INSERT INTO DISP_PROD VALUES ((SELECT PA_ID FROM PAIS WHERE PA_NOMBRE = 'UNITED STATES'),
(SELECT PR_CODIGO FROM PRODUCTO WHERE PR_NOMBRE ='Set de construcción de ejércitos'),10);
INSERT INTO DISP_PROD VALUES ((SELECT PA_ID FROM PAIS WHERE PA_NOMBRE = 'GERMANY'),
(SELECT PR_CODIGO FROM PRODUCTO WHERE PR_NOMBRE ='Set de construcción de ejércitos'),10);
...
(SELECT PR_CODIGO FROM PRODUCTO WHERE PR_NOMBRE ='Set de construcción de ejércitos'),10);
INSERT INTO DISP_PROD VALUES ((SELECT PA_ID FROM PAIS WHERE PA_NOMBRE = 'CANADA'),
(SELECT PR_CODIGO FROM PRODUCTO WHERE PR_NOMBRE ='458 Italia GT2'),10);
INSERT INTO DISP_PROD VALUES ((SELECT PA_ID FROM PAIS WHERE PA_NOMBRE = 'AUSTRIA'),
(SELECT PR_CODIGO FROM PRODUCTO WHERE PR_NOMBRE ='458 Italia GT2'),10);
INSERT INTO DISP_PROD VALUES ((SELECT PA_ID FROM PAIS WHERE PA_NOMBRE = 'BELGIUM'),
(SELECT PR_CODIGO FROM PRODUCTO WHERE PR_NOMBRE ='458 Italia GT2'),10);
INSERT INTO DISP_PROD VALUES ((SELECT PA_ID FROM PAIS WHERE PA_NOMBRE = 'DENMARK'),
(SELECT PR_CODIGO FROM PRODUCTO WHERE PR_NOMBRE ='LaFerrari'),10);
INSERT INTO DISP_PROD VALUES ((SELECT PA_ID FROM PAIS WHERE PA_NOMBRE = 'FRANCE'),
(SELECT PR_CODIGO FROM PRODUCTO WHERE PR_NOMBRE ='LaFerrari'),10);
INSERT INTO DISP_PROD VALUES ((SELECT PA_ID FROM PAIS WHERE PA_NOMBRE = 'SWEDEN'),
(SELECT PR_CODIGO FROM PRODUCTO WHERE PR_NOMBRE ='LaFerrari'),10);
INSERT INTO DISP_PROD VALUES ((SELECT PA_ID FROM PAIS WHERE PA_NOMBRE = 'SWEDEN'),
(SELECT PR_CODIGO FROM PRODUCTO WHERE PR_NOMBRE ='Audi R18 e-tron quattro'),10);
INSERT INTO DISP_PROD VALUES ((SELECT PA_ID FROM PAIS WHERE PA_NOMBRE = 'UNITED STATES'),
(SELECT PR_CODIGO FROM PRODUCTO WHERE PR_NOMBRE ='Audi R18 e-tron quattro'),10);
INSERT INTO DISP_PROD VALUES ((SELECT PA_ID FROM PAIS WHERE PA_NOMBRE = 'GERMANY'),
(SELECT PR_CODIGO FROM PRODUCTO WHERE PR_NOMBRE ='Audi R18 e-tron quattro'),10);
...
(SELECT PR_CODIGO FROM PRODUCTO WHERE PR_NOMBRE ='Audi R18 e-tron quattro'),10);
INSERT INTO DISP_PROD VALUES ((SELECT PA_ID FROM PAIS WHERE PA_NOMBRE = 'CANADA'),
(SELECT PR_CODIGO FROM PRODUCTO WHERE PR_NOMBRE ='Chevrolet Corvette Z06'),10);
INSERT INTO DISP_PROD VALUES ((SELECT PA_ID FROM PAIS WHERE PA_NOMBRE = 'ENGLAND'),
(SELECT PR_CODIGO FROM PRODUCTO WHERE PR_NOMBRE ='Chevrolet Corvette Z06'),10);
INSERT INTO DISP_PROD VALUES ((SELECT PA_ID FROM PAIS WHERE PA_NOMBRE = 'AUSTRIA'),
(SELECT PR_CODIGO FROM PRODUCTO WHERE PR_NOMBRE ='Ford Mustang GT'),10);
INSERT INTO DISP_PROD VALUES ((SELECT PA_ID FROM PAIS WHERE PA_NOMBRE = 'BELGIUM'),
(SELECT PR_CODIGO FROM PRODUCTO WHERE PR_NOMBRE ='Ford Mustang GT'),10);
INSERT INTO DISP_PROD VALUES ((SELECT PA_ID FROM PAIS WHERE PA_NOMBRE = 'DENMARK'),
(SELECT PR_CODIGO FROM PRODUCTO WHERE PR_NOMBRE ='Ford Mustang GT'),10);
INSERT INTO DISP_PROD VALUES ((SELECT PA_ID FROM PAIS WHERE PA_NOMBRE = 'DENMARK'),
(SELECT PR_CODIGO FROM PRODUCTO WHERE PR_NOMBRE ='Porsche 918 Spyder'),10);
INSERT INTO DISP_PROD VALUES ((SELECT PA_ID FROM PAIS WHERE PA_NOMBRE = 'FRANCE'),
(SELECT PR_CODIGO FROM PRODUCTO WHERE PR_NOMBRE ='Porsche 918 Spyder'),10);
INSERT INTO DISP_PROD VALUES ((SELECT PA_ID FROM PAIS WHERE PA_NOMBRE = 'SWEDEN'),
(SELECT PR_CODIGO FROM PRODUCTO WHERE PR_NOMBRE ='Porsche 918 Spyder'),10);
...
(SELECT PR_CODIGO FROM PRODUCTO WHERE PR_NOMBRE ='Porsche 918 Spyder'),10);
INSERT INTO DISP_PROD VALUES ((SELECT PA_ID FROM PAIS WHERE PA_NOMBRE = 'UNITED STATES'),
(SELECT PR_CODIGO FROM PRODUCTO WHERE PR_NOMBRE ='Audi R8 LMS ultra'),10);
INSERT INTO DISP_PROD VALUES ((SELECT PA_ID FROM PAIS WHERE PA_NOMBRE = 'GERMANY'),
(SELECT PR_CODIGO FROM PRODUCTO WHERE PR_NOMBRE ='Audi R8 LMS ultra'),10);
INSERT INTO DISP_PROD VALUES ((SELECT PA_ID FROM PAIS WHERE PA_NOMBRE = 'ENGLAND'),
(SELECT PR_CODIGO FROM PRODUCTO WHERE PR_NOMBRE ='Audi R8 LMS ultra'),10);
...
INSERT INTO DISP_PROD VALUES(6,75899,10);
INSERT INTO DISP_PROD VALUES(4,75899,10);
/*Puesto reparacion porsche*/
INSERT INTO DISP_PROD VALUES(2,75876,10);
INSERT INTO DISP_PROD VALUES(7,75876,10);
INSERT INTO DISP_PROD VALUES(9,75876,10);
INSERT INTO DISP_PROD VALUES(3,75876,10);
...
exec INSERTAR_DETALLE_PEDIDO(6,5,75899,200,130);
exec INSERTAR_DETALLE_PEDIDO(7,2,75899,100,150);
exec INSERTAR_DETALLE_PEDIDO(8,6,75899,200,500);
exec INSERTAR_DETALLE_PEDIDO(9,9,75899,100,200);
exec INSERTAR_DETALLE_PEDIDO(10,8,75899,200,300);
exec INSERTAR_DETALLE_PEDIDO(11,5,70747,100,200);
exec INSERTAR_DETALLE_PEDIDO(12,4,75899,200,100);
...
exec INSERTAR_DETALLE_PEDIDO(17,2,75876,100,150);
exec INSERTAR_DETALLE_PEDIDO(18,7,75876,200,500);
exec INSERTAR_DETALLE_PEDIDO(19,9,75876,100,600);
exec INSERTAR_DETALLE_PEDIDO(20,3,75876,200,100);
...
begin
  ...
  a_prod(2) := 5005117;
  a_cant(2) := 5;  
  NUEVA_VENTA.REALIZAR_VENTA(1,2,a_prod,a_cant);
  a_prod(1) := 75876;
  a_cant(1) := 1;  
  a_prod(2) := 5005117;
  a_cant(2) := 3;  
  NUEVA_VENTA.REALIZAR_VENTA(1,3,a_prod,a_cant);
  a_prod(1) := 75899;
  a_cant(1) := 3;  
  a_prod(2) := 75899;
  a_cant(2) := 4;  
  NUEVA_VENTA.REALIZAR_VENTA(6,4,a_prod,a_cant);
  a_prod(1) := 75899;
  a_cant(1) := 3;  
  a_prod(2) := 75899;
  a_cant(2) := 4;  
  NUEVA_VENTA.REALIZAR_VENTA(6,5,a_prod,a_cant);

  a_prod(1) := 5005117;
  a_cant(1) := 6;  
  a_prod(2) := 5005117;
  a_cant(2) := 2;  
  NUEVA_VENTA.REALIZAR_VENTA(2,2,a_prod,a_cant);
  a_prod(1) := 75876;
  a_cant(1) := 1;  
  a_prod(2) := 5005117;
  a_cant(2) := 2;  
  NUEVA_VENTA.REALIZAR_VENTA(2,3,a_prod,a_cant);
  a_prod(1) := 75899;
  a_cant(1) := 7;  
  a_prod(2) := 75899;
  a_cant(2) := 4;  
  NUEVA_VENTA.REALIZAR_VENTA(7,4,a_prod,a_cant);
  a_prod(1) := 75899;
  a_cant(1) := 8;  
  a_prod(2) := 75899;
  a_cant(2) := 3;  
  NUEVA_VENTA.REALIZAR_VENTA(7,5,a_prod,a_cant);
  a_prod(1) := 5005117;
  a_cant(1) := 5;  
  a_prod(2) := 75876;
  a_cant(2) := 1;  
  NUEVA_VENTA.REALIZAR_VENTA(2,6,a_prod,a_cant);

  a_prod(1) := 5005117;
  a_cant(1) := 1;  
  a_prod(2) := 5005117;
  a_cant(2) := 1;  
  NUEVA_VENTA.REALIZAR_VENTA(3,3,a_prod,a_cant);
  a_prod(1) := 75899;
  a_cant(1) := 2;  
  a_prod(2) := 75899;
  a_cant(2) := 2;  
  NUEVA_VENTA.REALIZAR_VENTA(8,4,a_prod,a_cant);
  a_prod(1) := 75899;
  a_cant(1) := 3;  
  a_prod(2) := 75899;
  a_cant(2) := 3;  
  NUEVA_VENTA.REALIZAR_VENTA(8,5,a_prod,a_cant);
  a_prod(1) := 5005117;
  a_cant(1) := 4;  
  a_prod(2) := 5005117;
  a_cant(2) := 4;  
  NUEVA_VENTA.REALIZAR_VENTA(3,6,a_prod,a_cant);
  a_prod(1) := 5005117;
  a_cant(1) := 5;  
  a_prod(2) := 5005117;
  a_cant(2) := 5;  
  NUEVA_VENTA.REALIZAR_VENTA(3,7,a_prod,a_cant);

  a_prod(1) := 75899;
  a_cant(1) := 5;  
  a_prod(2) := 75899;
  a_cant(2) := 5;  
  NUEVA_VENTA.REALIZAR_VENTA(9,4,a_prod,a_cant);
  a_prod(1) := 75899;
  a_cant(1) := 4;  
  a_prod(2) := 75899;
  a_cant(2) := 4;  
  NUEVA_VENTA.REALIZAR_VENTA(9,5,a_prod,a_cant);
  a_prod(1) := 5005117;
  a_cant(1) := 3;  
  a_prod(2) := 5005117;
  a_cant(2) := 3;  
  NUEVA_VENTA.REALIZAR_VENTA(4,6,a_prod,a_cant);
  a_prod(1) := 5005117;
  a_cant(1) := 2;  
  a_prod(2) := 5005117;
  a_cant(2) := 2;  
  NUEVA_VENTA.REALIZAR_VENTA(4,7,a_prod,a_cant);
  a_prod(1) := 5005117;
  a_cant(1) := 1;  
  a_prod(2) := 5005117;
  a_cant(2) := 1;  
  NUEVA_VENTA.REALIZAR_VENTA(4,8,a_prod,a_cant);

  a_prod(1) := 5005117;
  a_cant(1) := 5;  
  a_prod(2) := 5005117;
  a_cant(2) := 1;  
  NUEVA_VENTA.REALIZAR_VENTA(5,5,a_prod,a_cant);
  a_prod(1) := 75899;
  a_cant(1) := 4;  
  a_prod(2) := 75899;
  a_cant(2) := 2;  
  NUEVA_VENTA.REALIZAR_VENTA(10,6,a_prod,a_cant);
  a_prod(1) := 5005117;
  a_cant(1) := 3;  
  a_prod(2) := 5005117;
  a_cant(2) := 3;  
  NUEVA_VENTA.REALIZAR_VENTA(5,7,a_prod,a_cant);
  a_prod(1) := 75899;
  a_cant(1) := 2;  
  a_prod(2) := 75899;
  a_cant(2) := 4;  
  NUEVA_VENTA.REALIZAR_VENTA(10,8,a_prod,a_cant);
  a_prod(1) := 5005117;
  a_cant(1) := 1;  
  a_prod(2) := 5005117;
  a_cant(2) := 5;  
  NUEVA_VENTA.REALIZAR_VENTA(5,9,a_prod,a_cant);
end;
/
