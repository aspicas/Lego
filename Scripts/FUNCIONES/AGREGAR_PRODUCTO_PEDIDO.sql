...
ELSE
     ...
     SELECT DP_ID INTO ID_DETALLE FROM DETALLE_PEDIDO, PEDIDO WHERE DP_FK_PEDIDO = PD_ORDEN AND PD_ORDEN = ID_PEDIDO ;
     /*
     
     --SELECT COUNT(*) INTO CUENTA FROM PRODUCCION_LOTE WHERE PL_FK_HIST_FABRICA=FABRICA AND PL_FK_HIST_PRODUCTO = LEGO;
     SELECT PL_ID_LOTE INTO P_LOTE FROM PRODUCCION_LOTE WHERE PL_FK_HIST_FABRICA=FABRICA AND PL_FK_HIST_PRODUCTO = LEGO;
     
     --MODULO := CANTIDAD_LOTE - CANT;
     */

     INSERT INTO DET_LOTE VALUES (4,ID_PEDIDO,ID_DETALLE,11);
...
ELSE
     ...
     */
     ...
     INSERT INTO DET_LOTE VALUES (2,ID_PEDIDO,ID_DETALLE,11);
