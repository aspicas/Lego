...
INSERT INTO ESTADO_CIUDAD VALUES (SQ_ESTADO_CIUDAD_ID.NEXTVAL,NULL,(SELECT PA_ID FROM PAIS WHERE PA_NOMBRE='UNITED STATES'),'FLORIDA','ESTADO');
...
INSERT INTO ESTADO_CIUDAD VALUES (SQ_ESTADO_CIUDAD_ID.NEXTVAL,(SELECT EC_ID FROM ESTADO_CIUDAD WHERE EC_TIPO = 'ESTADO' AND EC_NOMBRE = 'FLORIDA'),(SELECT PA_ID FROM PAIS WHERE PA_NOMBRE='UNITED STATES'),'SAINT PETERSBURG','CIUDAD');
INSERT INTO ESTADO_CIUDAD VALUES (SQ_ESTADO_CIUDAD_ID.NEXTVAL,(SELECT EC_ID FROM ESTADO_CIUDAD WHERE EC_TIPO = 'ESTADO' AND EC_NOMBRE = 'FLORIDA'),(SELECT PA_ID FROM PAIS WHERE PA_NOMBRE='UNITED STATES'),'WINTER HAVEN','CIUDAD');
...
INSERT INTO ESTADO_CIUDAD VALUES (SQ_ESTADO_CIUDAD_ID.NEXTVAL,(SELECT EC_ID FROM ESTADO_CIUDAD WHERE EC_TIPO = 'ESTADO' AND EC_NOMBRE = 'BAJA AUSTRIA'),(SELECT PA_ID FROM PAIS WHERE PA_NOMBRE='AUSTRIA'),'VÃ–SENDORF','CIUDAD');
