...
INSERT INTO FACTURA_ONLINE VALUES (SQ_FACTURA_ONLINE_ID.NEXTVAL,(select cv_id from cliente_visitante where rownum = 1)+1,'13-ene-98',23.4);
INSERT INTO FACTURA_ONLINE VALUES (SQ_FACTURA_ONLINE_ID.NEXTVAL,(select cv_id from cliente_visitante where rownum = 1)+2,'16-ene-98',13.4);
INSERT INTO FACTURA_ONLINE VALUES (SQ_FACTURA_ONLINE_ID.NEXTVAL,(select cv_id from cliente_visitante where rownum = 1)+3,'20-ene-98',26.4);
INSERT INTO FACTURA_ONLINE VALUES (SQ_FACTURA_ONLINE_ID.NEXTVAL,(select cv_id from cliente_visitante where rownum = 1)+4,'29-ene-98',23.4);
INSERT INTO FACTURA_ONLINE VALUES (SQ_FACTURA_ONLINE_ID.NEXTVAL,(select cv_id from cliente_visitante where rownum = 1)+5,'09-ene-98',43.4);
